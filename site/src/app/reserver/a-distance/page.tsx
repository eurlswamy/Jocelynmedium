...
export default function ADistancePage() {
  return (
        ...
        <div className="relative max-w-3xl mx-auto px-6 md:px-12">
          ...
          >
            ...
            <p className="font-sans text-[10.5px] tracking-[0.3em] uppercase mb-2" style={{ color: ACCENT }}>
              Réservation · 30 minutes par téléphone
            </p>
            ...
            >
              <div className="min-w-0">
                ...
                <p className="font-serif text-encre text-lg">
                  Par téléphone{" "}
                  <span className="font-sans text-encre/55 text-sm ml-1">(30 minutes)</span>
                </p>
              </div>
              <div className="flex items-baseline gap-1 shrink-0">
                <span className="font-sans font-semibold text-3xl tabular-nums leading-none" style={{ color: ACCENT }}>85</span>
                <span className="font-sans text-base text-encre/65">€</span>
              </div>
            </div>

            <PaymentButton formuleSlug="a-distance" priceEur={85} accentHex={ACCENT} />
          </div>
            ...
            <div className="flex items-center justify-between gap-3 sm:gap-4 mb-5">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <h2 className="font-serif text-xl sm:text-2xl text-ivoire leading-tight whitespace-nowrap">30 minutes</h2>
                </div>
              </div>
              <div className="flex items-baseline gap-1 shrink-0">
                <span className="font-sans font-semibold text-3xl sm:text-4xl text-ivoire leading-none tabular-nums">85</span>
